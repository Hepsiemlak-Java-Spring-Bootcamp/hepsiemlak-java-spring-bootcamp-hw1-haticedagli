...
public class Workplace extends Advert {
    ...
    public Workplace(
        ...
        super(AdvertType.WORKPLACE, category, address, navigableByVideoCall, availableForLoan, swap, rentalIncome, releaseType, images);
